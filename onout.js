          ...
          exec(
            ...
            (error, stdout, stderr) => {
              ...
              res.send(
                ...
                Success. Your app will be availabe at https://chate-git-${nm}-marsiandeployer.vercel.app/ in <span id=incomeTicker></span> sec. Enjoy :) Plesae note if you send form again domain will be changed . 
                <br><Br><br>
